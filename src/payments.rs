use crate::{
    CapturePaymentBody, CapturePaymentResponse, Client, CreatePaymentRequest,
    CreatePaymentResponse, Error, GetPaymentActionsResponse, GetPaymentDetailsResponse,
    RefundPaymentBody, RefundPaymentResponse, VoidPaymentBody, VoidPaymentResponse,
};
...
impl<'a> Payments<'a> {
    ...
    pub async fn create_payment(
        ...
        let response = self
            .client
            .send_post_request_2("gateway", &url, request)
            .await?;
